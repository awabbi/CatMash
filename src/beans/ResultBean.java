...
public class ResultBean {
	...
	/**
	 * A function that picks to cats randomly from the list. The cats are always different. This is called by CatMashBean bean.
	...
	private double totalScore(int from, int to) {
		...
		return directScore(from, to) + ((count==0)? 0 : sum/count);
	}
